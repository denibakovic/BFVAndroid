...
public class KalmanFilter {
    ...
    public void update(double z_abs, double var_z_abs, double dt) {
        ...
        //System.out.println(k_abs);
    }

    // Getters for the state and its covariance.
    public double getXAbs() { return x_abs; }
    public double getXVel() { return x_vel; }
    public double getCovAbsAbs() { return p_abs_abs; }
    public double getCovAbsVel() { return p_abs_vel; }
    public double getCovVelVel() { return p_vel_vel; }
}
